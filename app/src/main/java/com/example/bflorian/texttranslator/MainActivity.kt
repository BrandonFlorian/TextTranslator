...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // var camera_capture_button: Button = findViewById<Button>(R.id.camera_capture_button)
        ...
        SettingsActivity.outputLanguageCode = "fr"
        SettingsActivity.outputLanguage = "French"
        SettingsActivity.inputLanguageCode = "en"
        SettingsActivity.inputLanguage = "English"

        getModels(SettingsActivity.outputLanguageCode)
        getModels(SettingsActivity.inputLanguageCode)
